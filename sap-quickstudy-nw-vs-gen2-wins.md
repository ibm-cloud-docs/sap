...
<!-- !!! Other images (or no) need be here !!!
Given that we have two virtual servers of the same layout, per the example, Figures 4 and 5 are an overview of the virtual servers and the block storage volumes. -->
