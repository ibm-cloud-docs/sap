...
Our rigorous certification process with SAP ensures that your workloads are supported.
...
For more details on SAP S/4HANA scale-out with IBM Cloud, please read [SAP S/4HANA additional design considerations](/docs/sap?topic=sap-s4hana) which describes while this is possible, IBM-SAP prefer to discuss first to understand the business requirements. This is to avoid transactional performance issues which may occur with SAP S/4HANA scale-out.
{: note}

### Benchmarks summary
{: #iaas-benchmarks-summary}

- SAP S/4HANA (AnyPremise edition), which uses SAP HANA scale-up _**(world record, as of writing - 2020-07-01)**_
- SAP BW/4HANA, which uses SAP HANA scale-up _**(world record, as of writing - 2020-07-01)**_
- SAP BW/4HANA, which uses SAP HANA scale-out
...
This exercise provides you enough information to establish what IaaS and surrounding needs you might have, which can help to evaluate decision points such as:
...
- Whether to migrate the existing SAP ECC system to SAP S/4HANA, or build from the ground up on cloud
- What your current sizing of your SAP Systems are, and their projected increases
