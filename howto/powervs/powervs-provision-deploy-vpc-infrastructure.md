...
![VPC landing zone for SAP on {{site.data.keyword.powerSys_notm}}](../../images/powervs-provision-step1.svg){: caption="VPC landing zone for SAP on {{site.data.keyword.powerSys_notm}}" caption-side="bottom"}
