...
This document describes the overview and the architecture of the SAP NetWeaver 7.5 solution with Db2 as the underlying database running on Red Hat&reg; Enterprise Linux&reg; 9.4 operating system in the {{site.data.keyword.vpc_short}} environment.
