...
| mx2-16x128 | IBM Cloud Intel Virtual Server (Gen2) | - | 16 | Intel Cascade Lake SP | 128 | 8.00 | 20,560 | Yes | Appliance | OLTP |
| mx2-32x256 | IBM Cloud Intel Virtual Server (Gen2) | - | 32 | Intel Cascade Lake SP | 256 | 8.00 | 41,130 | Yes | Appliance | OLTP |
| mx2-48x384 | IBM Cloud Intel Virtual Server (Gen2) | - | 48 | Intel Cascade Lake SP | 384 | 8.00 | 56,970 | Yes | Appliance | OLTP |
...
| mx2-16x128 | IBM Cloud Intel Virtual Server (Gen2) | <ul><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2369){: external}</li></ul> |
| mx2-32x256 | IBM Cloud Intel Virtual Server (Gen2) | <ul><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2370){: external}</li></ul> |
| mx2-48x384 | IBM Cloud Intel Virtual Server (Gen2) | <ul><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2371){: external}</li></ul> |
