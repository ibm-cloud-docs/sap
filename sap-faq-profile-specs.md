...
- [Intel Virtual Server (VPC) certified profiles for SAP HANA](/docs/sap?topic=sap-hana-iaas-offerings-profiles-intel-vs-vpc)
...
| BI.S4.H2.384_v3 | IBM Cloud Bare Metal (Local SSD) | 16 | 32 | 384 | 60,420 | Intel Cascade Lake SP | 12.00 | Appliance | OLAP/OLTP | Classic |
...
| BI.S4.H2.768_v2 | IBM Cloud Bare Metal (Local SSD) | 48 | 96 | 768 | 124,620 | Intel Cascade Lake SP | 8.00 | Appliance | OLAP/OLTP | Classic |
| BI.S4.H2.768_v3 | IBM Cloud Bare Metal (Local SSD) | 16 | 32 | 768 | 60,420 | Intel Cascade Lake SP | 24.00 | Appliance | OLAP/OLTP | Classic |
...
| BI.S4.H2.1500 | IBM Cloud Bare Metal (Local SSD) | <ul><li>[OLAP (`*`) Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2191){: external}</li><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2253){: external}</li></ul> |
| BI.S4.H2.3000 | IBM Cloud Bare Metal (Local SSD) | <ul><li>[OLAP (`*`) Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2425){: external}</li><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2251){: external}</li></ul> |
...
| BI.S4.H4.6000 | IBM Cloud Bare Metal (Local SSD) | <ul><li>[OLAP (`*`) Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2213){: external}</li><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2247){: external}</li></ul> |
| BI.S4.H8.6000 | IBM Cloud Bare Metal (Local SSD) | <ul><li>[OLAP (`*`) Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2305){: external}</li><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2303){: external}</li></ul> |
| BI.S4.H8.12000 | IBM Cloud Bare Metal (Local SSD) | <ul><li>[OLAP (`*`) Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2302){: external}</li><li>[OLTP  (`*`) Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2304){: external}</li></ul> |
...
| BI.S4.H2.1500 (VMware) | IBM Cloud for VMware (Local SSD) | <ul><li>[OLAP (`*`) Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2191){: external}</li><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2253){: external}</li></ul> |
| BI.S4.H2.3000 (VMware) | IBM Cloud for VMware (Local SSD) | <ul><li>[OLAP (`*`) Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2425){: external}</li><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2251){: external}</li></ul> |
...
| BI.S4.H4.6000 (VMware) | IBM Cloud for VMware (Local SSD) | <ul><li>[OLAP (`*`) Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2213){: external}</li><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2247){: external}</li></ul> |
| BI.S4.H8.6000 (VMware) | IBM Cloud for VMware (Local SSD) | <ul><li>[OLAP (`*`) Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2305){: external}</li><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2303){: external}</li></ul> |
...
| ch1-60x3000 | IBM Power Virtual Server | <ul><li>[OLAP (`*`) Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2357){: external}</li><li>[OLTP Record](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas&id=s:2445){: external}</li></ul> |
