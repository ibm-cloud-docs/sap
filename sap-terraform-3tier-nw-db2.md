...
# Automating SAP NetWeaver 7.x and Db2 on 3-tier {{site.data.keyword.cloud}} VPC with Terraform and Ansible
...
3. On the **Specify template** page:
    * Enter the URL of the {{site.data.keyword.bpshort}} folder.
...
2. Clone the solution repository from `https://github.com/IBM-Cloud/sap-netweaver-abap-db2-distributed` and `cd` to the `sap-netweaver-abap-db2-distributed/cli/terraform` folder.
