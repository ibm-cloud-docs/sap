...
{: #exporting-sap-variables-as-bash-variables-sap}
...
{: #checking-connectivity-hdb-port-to-instance-ports}
...
{: #installing-sap-python-driver-hdbcli-sap}
...
{: #config-hdb-exporter-activating-daemon}
...
{: #config-host-exporter-and-activation}
...
## Next steps
{: #exporter-setup-next-steps}

If the setup and configuration of the monitoring host was successful, continue with [Configuration of Prometheus server metric forwarding](/docs/sap?topic=sap-metric-forwarding).
