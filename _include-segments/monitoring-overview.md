...
1. [SAP HANA DB dashboard](#dashboard-hana-db) - Designed specifically for monitoring SAP HANA databases.
1. [SAP System dashboard](#dashboard-sap-system) - Tailored for monitoring all SAP instances of the configured SAP solution.
