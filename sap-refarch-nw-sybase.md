...
![Figure 3. Distribured architecture Sybase](images/refarch-sap-syb-dist-only.svg "SAP NetWearver 7.x SYB distributed installation with AAS"){: caption="SAP NetWeaver SYB standard installation with AAS" caption-side="bottom"}
