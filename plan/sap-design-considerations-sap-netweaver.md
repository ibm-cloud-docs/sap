...
- [New Failover Clustering Improvements in Windows Server 2012 and Its Benefits for SAP NetWeaver High Availability](https://community.sap.com/t5/technology-blog-posts-by-sap/new-failover-clustering-improvements-in-windows-server-2012-and-its/ba-p/13023326){: external} provides a description based on Microsoft Windows Server Failover Clustering (WFSC) for SAP NetWeaver implementations.
